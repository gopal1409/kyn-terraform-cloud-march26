resource "aws_autoscaling_policy" "cpu_tracking_policy" {
  ...
  target_tracking_configuration {
    ...
    target_value           = 10.0 # Target 10% CPU .1 millicores of CPU utilization. When the average CPU utilization exceeds this value, the policy will trigger scaling actions.
